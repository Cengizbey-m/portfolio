...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    description: "Started a round of Slide Puzzle.",
    icon: "gamepad-2",
    rarity: "uncommon",
  },
  {
    ...
    description: "Rebuilt a scrambled photo in Slide Puzzle.",
    icon: "trophy",
    rarity: "rare",
  },
  {
    id: "puzzle-hard",
    title: "Fifteen and Rising",
    description: "Solved Slide Puzzle on a 4x4 board or larger.",
    icon: "trophy",
    rarity: "legendary",
  },
  {
